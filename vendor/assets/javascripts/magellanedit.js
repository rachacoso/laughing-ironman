;(function ($, window, document, undefined) {
  ...
  Foundation.libs['magellan-expedition'] = {
    ...
    settings : {
      active_class: 'RAactive',
      threshold: 10, // pixels from the top of the expedition for it to become fixes
    ...
    update_expedition_positions : function() {
      ...
      $('[' + this.attr_name() + '=fixed]', self.scope).each(function() {
        ...
        if (window_top_offset >= top_offset) {
          ...
          // LACO AUDIT CUSTOM EDIT show navbar auditname
          $(".subnav-auditName").show();
          expedition.css({position:'fixed', top: settings.fixed_top});
        } else {
          // LACO AUDIT CUSTOM EDIT rehide
